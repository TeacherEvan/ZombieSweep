import type { NpcDefinition, NpcDefinitionInput } from './Npc';
import { NpcFaction, NpcRarity, NpcRole, NpcState, NpcTimeSlice, createNpcDefinition } from './Npc';
    ...
    archetypes: [
      ...
      buildNpc({
        ...
        behavior: {
          ...
          fallbackState: NpcState.Flee,
          preferredStates: [NpcState.Trade, NpcState.Investigate, NpcState.Defend],
          caution: 0.45,
          aggression: 0.85,
          support: 0.05,
        },
    ...
    archetypes: [
      ...
      buildNpc({
        ...
        behavior: {
          defaultState: NpcState.Investigate,
          fallbackState: NpcState.Flee,
          preferredStates: [NpcState.Investigate, NpcState.Interact, NpcState.Travel],
          caution: 0.78,
          aggression: 0.15,
          support: 0.95,
        },
      ...
      buildNpc({
        ...
        behavior: {
          ...
          fallbackState: NpcState.Flee,
          preferredStates: [NpcState.Interact, NpcState.Travel, NpcState.Defend],
          caution: 0.75,
          aggression: 0.1,
          support: 1,
        },
...
export const NPC_ARCHETYPES: NpcDefinition[] = NPC_FAMILIES.flatMap(family => family.archetypes);
...
export function getNpcFamilyByFaction(faction: NpcFaction): NpcFamilyDefinition | undefined {
