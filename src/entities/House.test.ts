...
describe('House entities', () => {
  ...
  describe('cross-house behavior', () => {
    it('delivery difficulty escalates: Ranch < Colonial < Victorian', () => {
      ...
      const ranch = difficulties.indexOf(createRanchHouse(true).porchDifficulty);
      const colonial = difficulties.indexOf(createColonialHouse(true).porchDifficulty);
      const victorian = difficulties.indexOf(createVictorianHouse(true).porchDifficulty);
