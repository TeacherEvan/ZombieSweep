...
import { createRunner, createShambler, createSpitter, toNpcDefinition, ZombieType } from './Zombie';
...
describe('Zombie entities', () => {
  ...
  describe('combat scenarios', () => {
    ...
    it('runners are faster than shamblers', () => {
      expect(createRunner(0, 0).speed).toBeGreaterThan(createShambler(0, 0).speed);
    });
